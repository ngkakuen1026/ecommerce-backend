...
import { createProduct, deleteProduct, deleteProductImage, getAllProducts, getAllProductsByCategoryId, getProductById, getProductByUsername, getUserProducts, searchProducts, updateProduct, uploadProductImages } from '../controllers/productControllers';
